...
//       }]);
//       // Update conversation map – this will move chat to top
//       setConvMap(prev => ({
//         ...prev,
//         [selectedUser.id]: {
...
//       const userToSelect = users.find(u => u.id === parseInt(userIdParam));
//       if (userToSelect) {
//         setSelectedUser(userToSelect);
//         fetchMessages(userToSelect.id);
...
//       last_message_time: convMap[u.id]?.last_message_time || null,
...
//     padding: '8px 12px',
//     borderRadius: '18px',
//     backgroundColor: isSent ? '#dcf8c5' : '#f1f1f1',
//     wordWrap: 'break-word',
//     position: 'relative'
//   });
...
//                 {u.profile_picture ? (
//                   <img src={`http://localhost:8000${u.profile_picture}`} alt={u.full_name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//                 ) : (
//                   <span>👤</span>
//                 )}
//               </div>
...
//                   <span style={userNameStyle}>{u.full_name || 'अज्ञात'}</span>
//                   <span style={roleTagStyle}>({u.role === 'farmer' ? 'शेतकरी' : 'खरेदीदार'})</span>
//                 </div>
...
//                     <img src={`http://localhost:8000${selectedUser.profile_picture}`} alt={selectedUser.full_name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
//                   ) : (
//                     <span>👤</span>
//                   )}
//                 </div>
//                 <div>
//                   <strong style={{ fontSize: '16px' }}>{selectedUser.full_name}</strong>
//                   <small style={{ marginLeft: '8px', color: '#666' }}>({selectedUser.role === 'farmer' ? 'शेतकरी' : 'खरेदीदार'})</small>
//                 </div>
//               </div>
...
//               {loadingMsgs && <div style={{ textAlign: 'center' }}>लोड करत आहे...</div>}
//               {messages.map(msg => (
//                 <div
//                   key={msg.id}
//                   style={messageWrapperStyle(msg.sender_id === user.id)}
...
//   // महत्त्वाची स्टेप: Socket मध्ये लेटेस्ट सिलेक्टेड यूजर मिळवण्यासाठी Ref वापरला आहे
...
//     setNewMessage(''); // Input लगेच रिकामं करा
...
//       // चॅट लिस्टमध्ये हा यूजर सर्वात वर येण्यासाठी ConvMap अपडेट करा
//       setConvMap(prev => ({
//         ...prev,
//         [selectedUser.id]: {
...
//   // ----- Delete / Clear logic (तसंच ठेवलं आहे) -----
//   const deleteMessage = async (messageId) => {
//     if (!window.confirm('हा मेसेज हटवायचा?')) return;
//     try {
//       await axios.delete(`http://localhost:8000/chat/messages/${messageId}`, {
...
//   // ----- Real-time Socket Integration (WhatsApp Style) -----
//   useEffect(() => {
//     const handleNewChatMessage = (data) => {
//       const now = Date.now();
//       const currentSelected = selectedUserRef.current;

//       // जर मेसेज आपल्याला आला असेल तर
//       if (data.receiver_id === user.id) {
//         // जर सध्या त्याच माणसाची चॅट विंडो उघडली असेल
...
//           }));
//         } else {
//           // विंडो बंद असेल तर फक्त बाहेरचा मेसेज आणि काऊंट अपडेट करा
//           setConvMap(prev => {
//             const existing = prev[data.sender_id] || {};
//             return {
//               ...prev,
...
//   // Sorting Logic: ज्याचा मेसेज लेटेस्ट तो सर्वात वर
...
//                   <span style={{ fontWeight: 'bold' }}>{u.full_name || 'अज्ञात'}</span>
